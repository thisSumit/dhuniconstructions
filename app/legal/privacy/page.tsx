  ...
  return (
    <main className="container text-white mx-auto px-4 py-10 my-[150px]">
        ...
        <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
                You have the right to access, update, or delete your personal data. For assistance, please contact us at <a href="mailto:info@dhuniconstructions.com" className="text-blue-600 underline">info@dhuniconstructions.com</a>.
            </p>
        </section>
