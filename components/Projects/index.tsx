    ...
    >
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent md:opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-0 left-0 md:p-6 py-4 pl-2 text-black">
                <p className="text-gray-300 leading-6 text-6xl mb-1 font-bold">{items.title}</p>
                  <p className="text-2xl my-2 leading-5 font-light">{items.location}</p>
                  <div className='flex text-[14px] md:text-sm items-center space-x-2 text-orange-400 hover:text-orange-300 transition-colors uppercase'>
