      ...
      <div className="relative h-full">
        ...
        >
          <div className="text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl text-sm leading-4 text-gray-200 md:text-lg">
        ...
        <div
            onClick={toggleMute}
            className="absolute z-10 md:bottom-10 bottom-5 right-2 md:right-10 rounded-full bg-white text-black"
          >
              {isMuted ? <VolumeX className="h-[34px] w-[34px] p-2" /> : <Volume2 className="h-[34px] w-[34px] p-2" />}
          </div>
      </div>
    </main>
  );
