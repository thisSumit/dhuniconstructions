        ...
        <div className='flex order-2 md:order-1 flex-col justify-center items-start'>
          ...
          <div className='flex flex-col items-start justify-between'>
            ...
            <button onClick={() => window.location.href = '/contact'} className=" uppercase group relative overflow-hidden border-[1px] border-white bg-white md:px-8 md:py-4 px-6 py-4 text-black transition-all duration-300 hover:border-orange-400">
              ...
              <button onClick={() => window.location.href = '/arctic'} className=" uppercase group relative overflow-hidden border-[1px] border-white bg-transparent md:px-8 md:py-4 px-6 py-4 text-black transition-all duration-300 hover:border-orange-400">
